...
import { MousePointerClick, Settings, BadgeCheck, FileCheck2, CreditCard } from 'lucide-react';

const ProcessTimeline: React.FC = () => {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
            <div className="text-center mb-20">
                <div className="inline-block px-3 py-1 rounded-full bg-blue-900/30 border border-blue-500/30 text-blue-400 text-xs font-bold uppercase tracking-widest mb-4">
                    The Blueprint
                </div>
            ...
            <div className="relative">
                ...
                <div className="space-y-16 md:space-y-28">
                    ...
                    <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-20 group">
                        ...
                        <div className="w-20 h-20 rounded-3xl bg-slate-900 border border-blue-500/50 flex items-center justify-center relative z-10 shadow-[0_0_40px_rgba(59,130,246,0.2)] order-1 md:order-2 group-hover:scale-110 transition-transform duration-500">
                            <MousePointerClick className="w-8 h-8 text-blue-400" />
                            <div className="absolute -inset-2 rounded-3xl border border-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        </div>
                    ...
                    <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-20 group">
                        ...
                        <div className="w-20 h-20 rounded-3xl bg-slate-900 border border-purple-500/50 flex items-center justify-center relative z-10 shadow-[0_0_40px_rgba(168,85,247,0.2)] order-1 md:order-2 group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-20 group">
                        ...
                        <div className="w-20 h-20 rounded-3xl bg-slate-900 border border-emerald-500/50 flex items-center justify-center relative z-10 shadow-[0_0_40px_rgba(16,185,129,0.2)] order-1 md:order-2 group-hover:scale-110 transition-transform duration-500">
